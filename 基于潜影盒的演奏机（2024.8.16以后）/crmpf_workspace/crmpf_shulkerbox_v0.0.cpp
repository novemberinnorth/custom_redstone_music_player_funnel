//custom redstone music player funnel shulkerbox v0.0
//本程序基于Java版Minecraft 1.17的游戏性质及在游戏中搭建的自定义红石音乐演奏机而编写
//本程序适配以下建筑：crmpf_arc_shulkerbox_w0.0.nbt  crmpf_arc_shulkerbox_w0.0.litematic
...
const std::string VERSION_SUFFIX = "_v0.0";//版本号后缀，用于区分不同版本的代码输出的文件
...
int main(){
    Clearall();
    std::cout << "crmpf_shulkerbox_v0.0" << "   如发现问题，请至 https://github.com/novemberinnorth/custom_redstone_music_player_funnel/issues 或向 citcra@foxmail.com 反馈。\n" << std::endl;
    //输入用户自定义数据
